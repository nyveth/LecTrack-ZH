    ...
    <>
      ...
      <div className="h-shell">
        <nav className="h-nav">
          ...
          {/* Единственный вход в приложение на узком экране: .h-navlinks
              там скрыт целиком. На десктопе не показывается, чтобы не
              дублировать ссылку Search. Метка та же самая: разные слова
              для одного действия читаются как две разные кнопки. */}
          <Link href="/chat" className="h-bracket h-narrow-only">
            Search
          </Link>
        </nav>
